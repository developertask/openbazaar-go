...
FROM golang:1.11
COPY . /go/src/github.com/developertask/openbazaar-go
RUN go build --ldflags '-extldflags "-static"' -o /opt/openbazaard /go/src/github.com/developertask/openbazaar-go
