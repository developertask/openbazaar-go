...
const bulkUpdateCurrencyJSON = ` { "currencies":["ZEC", "BTC", "BCH", "GLEEC"] }`
...
const moderatorValidJSON = `{
	"description": "Long time developertask moderator located in Chicago",
...
const walletAddressJSONResponse = `{
    ...
    "TGLEEC": "mtNyfJ4Sc38PFyCWMmGsYjAGrXsqwJ4gCD",
