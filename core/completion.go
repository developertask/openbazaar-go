...
func (n *developertaskNode) CompleteOrder(orderRatings *OrderRatings, contract *pb.RicardianContract, records []*wallet.TransactionRecord) error {
...
func (n *developertaskNode) DisputeIsActive(contract *pb.RicardianContract) (bool, error) {
	var (
...
func (n *developertaskNode) ReleaseFundsAfterTimeout(contract *pb.RicardianContract, records []*wallet.TransactionRecord) error {
...
func (n *developertaskNode) SignOrderCompletion(contract *pb.RicardianContract) (*pb.RicardianContract, error) {
...
func (n *developertaskNode) ValidateOrderCompletion(contract *pb.RicardianContract) error {
...
func (n *developertaskNode) ValidateAndSaveRating(contract *pb.RicardianContract) (retErr error) {
...
func (n *developertaskNode) updateRatingIndex(rating *pb.Rating, ratingPath string) error {
