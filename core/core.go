...
import (
	...
	sto "github.com/developertask/openbazaar-go/storage"
...
// developertaskNode - represent ob node which encapsulates ipfsnode, wallet etc
type developertaskNode struct {
	// IPFS node object
	IpfsNode *core.IpfsNode

	// An implementation of the custom DHT used by developertask
	DHT *dht.IpfsDHT
	...
	// The developertask network service for direct communication between peers
...
func (n *developertaskNode) TestNetworkEnabled() bool { return n.TestnetEnable }

// RegressionNetworkEnabled indicates whether the node is operating with regression parameters
func (n *developertaskNode) RegressionNetworkEnabled() bool { return n.RegressionTestEnable }

// SeedNode - publish to IPNS
func (n *developertaskNode) SeedNode() error {
	n.seedLock.Lock()
...
func (n *developertaskNode) publish(hash string) {
...
func (n *developertaskNode) sendToPushNodes(hash string) error {
...
func (n *developertaskNode) retryableSeedStoreToPeer(pid peer.ID, graphHash string, graph []cid.Cid) {
...
func (n *developertaskNode) SetUpRepublisher(interval time.Duration) {
	if interval == 0 {
		return
	}
...
func (n *developertaskNode) EncryptMessage(peerID peer.ID, peerKey *libp2p.PubKey, message []byte) (ct []byte, rerr error) {
...
func (n *developertaskNode) IPFSIdentityString() string {
...
func (n *developertaskNode) GetNodeID() (*pb.ID, error) {
	var id = new(pb.ID)
...
func (n *developertaskNode) Sign(payload []byte) ([]byte, error) {
