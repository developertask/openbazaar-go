...
import (
	...
	"github.com/developertask/openbazaar-go/util"
)
...
func (n *developertaskNode) OpenDispute(orderID string, contract *pb.RicardianContract, records []*wallet.TransactionRecord, claim string) error {
...
func (n *developertaskNode) verifyEscrowFundsAreDisputeable(contract *pb.RicardianContract, records []*wallet.TransactionRecord) bool {
	order, err := repo.ToV5Order(contract.BuyerOrder, n.LookupCurrency)
	if err != nil {
		return false
	}
...
func (n *developertaskNode) SignDispute(contract *pb.RicardianContract) (*pb.RicardianContract, error) {
...
func (n *developertaskNode) VerifySignatureOnDisputeOpen(contract *pb.RicardianContract, peerID string) error {
	var pubkey []byte
...
func (n *developertaskNode) ProcessDisputeOpen(rc *pb.RicardianContract, peerID string) error {
	DisputeWg.Add(1)
...
func (n *developertaskNode) CloseDispute(orderID string, buyerPercentage, vendorPercentage float32, resolution string, paymentCoinHint *repo.CurrencyCode) error {
...
func (n *developertaskNode) SignDisputeResolution(contract *pb.RicardianContract) (*pb.RicardianContract, error) {
...
func (n *developertaskNode) ValidateCaseContract(contract *pb.RicardianContract) []string {
...
func (n *developertaskNode) ValidateDisputeResolution(contract *pb.RicardianContract) error {
...
func (n *developertaskNode) verifyPaymentDestinationIsInWallet(output *pb.DisputeResolution_Payout_Output, wal wallet.Wallet) error {
...
func (n *developertaskNode) verifySignatureOnDisputeResolution(contract *pb.RicardianContract) error {
...
func (n *developertaskNode) ReleaseFunds(contract *pb.RicardianContract, records []*wallet.TransactionRecord) error {
	orderID, err := n.CalcOrderID(contract.BuyerOrder)
	if err != nil {
		return err
	}
