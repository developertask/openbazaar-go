...
func (n *developertaskNode) FulfillOrder(fulfillment *pb.OrderFulfillment, contract *pb.RicardianContract, records []*wallet.TransactionRecord) error {
...
func (n *developertaskNode) SignOrderFulfillment(contract *pb.RicardianContract) (*pb.RicardianContract, error) {
...
func (n *developertaskNode) ValidateOrderFulfillment(fulfillment *pb.OrderFulfillment, contract *pb.RicardianContract) error {
...
func (n *developertaskNode) IsFulfilled(contract *pb.RicardianContract) bool {
