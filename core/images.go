...
func (n *developertaskNode) SetAvatarImages(base64ImageData string) (*pb.Profile_Image, error) {
...
func (n *developertaskNode) SetHeaderImages(base64ImageData string) (*pb.Profile_Image, error) {
...
func (n *developertaskNode) SetProductImages(base64ImageData, filename string) (*pb.Profile_Image, error) {
	return n.resizeImage(base64ImageData, filename, 120, 120)
}

func (n *developertaskNode) resizeImage(base64ImageData, filename string, baseWidth, baseHeight int) (*pb.Profile_Image, error) {
...
func (n *developertaskNode) addImage(img image.Image, imgPath string) (string, error) {
...
func (n *developertaskNode) addResizedImage(img image.Image, w, h int, imgPath string) (string, error) {
...
func (n *developertaskNode) FetchAvatar(peerID string, size string, useCache bool) (io.ReadSeeker, error) {
	return n.FetchImage(peerID, "avatar", size, useCache)
}

// FetchHeader - fetch image header from ipfs
func (n *developertaskNode) FetchHeader(peerID string, size string, useCache bool) (io.ReadSeeker, error) {
	return n.FetchImage(peerID, "header", size, useCache)
}

// FetchImage - fetch ipfs image
func (n *developertaskNode) FetchImage(peerID string, imageType string, size string, useCache bool) (io.ReadSeeker, error) {
...
func (n *developertaskNode) GetBase64Image(url string) (base64ImageData, filename string, err error) {
...
func (n *developertaskNode) maybeMigrateImageHashes(listing *repo.Listing) error {
