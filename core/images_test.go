...
func TestdevelopertaskNode_maybeMigrateImageHashes(t *testing.T) {

	ipfsNode, err := coremock.NewMockNode()
	if err != nil {
		t.Fatal(err)
	}
	testRepo, err := schema.NewCustomSchemaManager(schema.SchemaContext{
	...
	node := developertaskNode{IpfsNode: ipfsNode, RepoPath: testRepo.DataPath()}
