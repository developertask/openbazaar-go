...
func (n *developertaskNode) GetLocalInventory() (Inventory, error) {
...
func (n *developertaskNode) GetLocalInventoryForSlug(slug string) (*InventoryListing, error) {
...
func (n *developertaskNode) PublishInventory() error {
...
func (n *developertaskNode) GetPublishedInventoryBytes(p peer.ID, useCache bool) ([]byte, error) {
...
func (n *developertaskNode) GetPublishedInventoryBytesForSlug(p peer.ID, slug string, useCache bool) ([]byte, error) {
