...
func (n *developertaskNode) SetListingInventory(l repo.Listing) error {
	err := l.ValidateSkus()
	if err != nil {
		return err
	}
...
func (n *developertaskNode) CreateListing(r []byte) (string, error) {
...
func (n *developertaskNode) UpdateListing(r []byte, publish bool) error {
...
func (n *developertaskNode) validateListingIsSellable(l repo.Listing) error {
...
func (n *developertaskNode) saveListing(l repo.Listing, publish bool) error {
...
func (n *developertaskNode) updateListingCoupons(l *repo.Listing) error {
	cs, err := l.GetCoupons()
	if err != nil {
...
func (n *developertaskNode) toListingIndexData(l *repo.Listing) (repo.ListingIndexData, error) {
	var (
...
func (n *developertaskNode) getListingIndex() ([]repo.ListingIndexData, error) {
...
func (n *developertaskNode) updateListingOnDisk(index []repo.ListingIndexData, ld repo.ListingIndexData, updateRatings bool) error {
	indexPath := path.Join(n.RepoPath, "root", "listings.json")
...
func (n *developertaskNode) updateRatingInListingIndex(rating *pb.Rating) error {
	index, err := n.getListingIndex()
	if err != nil {
		return err
	}
...
func (n *developertaskNode) UpdateEachListingOnIndex(updateListing func(*repo.ListingIndexData) error) error {
	indexPath := path.Join(n.RepoPath, "root", "listings.json")
...
func (n *developertaskNode) GetListingCount() int {
	indexPath := path.Join(n.RepoPath, "root", "listings.json")
...
func (n *developertaskNode) IsItemForSale(listing *pb.Listing) bool {
...
func (n *developertaskNode) DeleteListing(slug string) error {
...
func (n *developertaskNode) GetListings() ([]byte, error) {
	indexPath := path.Join(n.RepoPath, "root", "listings.json")
	file, err := ioutil.ReadFile(indexPath)
...
func (n *developertaskNode) GetListingFromHash(hash string) (*pb.SignedListing, error) {
	// Read listings.json
	indexPath := path.Join(n.RepoPath, "root", "listings.json")
	file, err := ioutil.ReadFile(indexPath)
	if err != nil {
...
func (n *developertaskNode) GetListingFromSlug(slug string) (*pb.SignedListing, error) {
	// Read listing file
...
func (n *developertaskNode) SetCurrencyOnListings(currencies []string) error {
