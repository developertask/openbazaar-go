...
func (n *developertaskNode) sendMessage(peerID string, k *libp2p.PubKey, message pb.Message) error {
...
func (n *developertaskNode) SendOfflineMessage(p peer.ID, k *libp2p.PubKey, m *pb.Message) error {
...
func (n *developertaskNode) SendOfflineAck(peerID string, pointerID peer.ID) error {
...
func (n *developertaskNode) GetPeerStatus(peerID string) (string, error) {
	p, err := peer.IDB58Decode(peerID)
	if err != nil {
		log.Errorf("failed to decode peerID: %v", err)
		return "", err
...
func (n *developertaskNode) Follow(peerID string) error {
...
func (n *developertaskNode) Unfollow(peerID string) error {
...
func (n *developertaskNode) ResendCachedOrderMessage(orderID string, msgType pb.Message_MessageType) error {
...
func (n *developertaskNode) SendOrder(peerID string, contract *pb.RicardianContract) (resp *pb.Message, err error) {
	p, err := peer.IDB58Decode(peerID)
	if err != nil {
		log.Errorf("failed to decode peerID: %v", err)
		return resp, err
...
func (n *developertaskNode) SendError(peerID string, k *libp2p.PubKey, errorMessage pb.Message) error {
	return n.sendMessage(peerID, k, errorMessage)
}

// SendOrderConfirmation - send order confirmed msg to peer
func (n *developertaskNode) SendOrderConfirmation(peerID string, contract *pb.RicardianContract) error {
...
func (n *developertaskNode) SendCancel(peerID, orderID string) error {
...
func (n *developertaskNode) SendReject(peerID string, rejectMessage *pb.OrderReject) error {
...
func (n *developertaskNode) SendRefund(peerID string, refundMessage *pb.RicardianContract) error {
...
func (n *developertaskNode) SendOrderFulfillment(peerID string, k *libp2p.PubKey, fulfillmentMessage *pb.RicardianContract) error {
...
func (n *developertaskNode) SendOrderCompletion(peerID string, k *libp2p.PubKey, completionMessage *pb.RicardianContract) error {
...
func (n *developertaskNode) SendDisputeOpen(peerID string, k *libp2p.PubKey, disputeMessage *pb.RicardianContract, orderID string) error {
...
func (n *developertaskNode) SendDisputeUpdate(peerID string, updateMessage *pb.DisputeUpdate) error {
...
func (n *developertaskNode) SendDisputeClose(peerID string, k *libp2p.PubKey, resolutionMessage *pb.RicardianContract, orderID string) error {
...
func (n *developertaskNode) SendFundsReleasedByVendor(peerID string, marshalledPeerPublicKey []byte, orderID string) error {
...
func (n *developertaskNode) SendChat(peerID string, chatMessage *pb.Chat) error {
...
func (n *developertaskNode) SendModeratorAdd(peerID string) error {
...
func (n *developertaskNode) SendModeratorRemove(peerID string) error {
...
func (n *developertaskNode) SendBlock(peerID string, id cid.Cid) error {
...
func (n *developertaskNode) SendStore(peerID string, ids []cid.Cid) error {
	var s []string
	for _, d := range ids {
		s = append(s, d.String())
	}
...
func (n *developertaskNode) SendOfflineRelay(peerID string, encryptedMessage []byte) error {
	m := pb.Message{
...
func (n *developertaskNode) SendOrderPayment(spend *SpendResponse) error {
