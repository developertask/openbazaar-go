...
func TestdevelopertaskNode_CalculateOrderTotal(t *testing.T) {
...
func TestdevelopertaskNode_CalculateOrderTotalWithV4Schema(t *testing.T) {
	node, err := test.NewNode()
	if err != nil {
		t.Error(err)
	}
...
func TestdevelopertaskNode_GetOrder(t *testing.T) {
	node, err := test.NewNode()
	if err != nil {
		t.Fatal(err)
	}
