...
func (n *developertaskNode) GeneratePostSlug(status string) (string, error) {
...
func (n *developertaskNode) SignPost(post *pb.Post) (*pb.SignedPost, error) {
...
func (n *developertaskNode) UpdatePostIndex(post *pb.SignedPost) error {
...
func (n *developertaskNode) extractpostData(post *pb.SignedPost) (postData, error) {
...
func (n *developertaskNode) getPostIndex() ([]postData, error) {
...
func (n *developertaskNode) updatePostOnDisk(index []postData, ld postData) error {
	indexPath := path.Join(n.RepoPath, "root", "posts.json")
...
func (n *developertaskNode) UpdatePostHashes(hashes map[string]string) error {
	indexPath := path.Join(n.RepoPath, "root", "posts.json")
...
func (n *developertaskNode) GetPostCount() int {
	indexPath := path.Join(n.RepoPath, "root", "posts.json")
...
func (n *developertaskNode) DeletePost(slug string) error {
...
func (n *developertaskNode) GetPosts() ([]byte, error) {
	indexPath := path.Join(n.RepoPath, "root", "posts.json")
	file, err := ioutil.ReadFile(indexPath)
	if os.IsNotExist(err) {
		return []byte("[]"), nil
...
func (n *developertaskNode) GetPostFromHash(hash string) (*pb.SignedPost, error) {
	// Read posts.json
	indexPath := path.Join(n.RepoPath, "root", "posts.json")
	file, err := ioutil.ReadFile(indexPath)
	if err != nil {
...
func (n *developertaskNode) GetPostFromSlug(slug string) (*pb.SignedPost, error) {
	// Read post file
