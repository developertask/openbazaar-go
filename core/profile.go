...
func (n *developertaskNode) GetProfile() (pb.Profile, error) {
...
func (n *developertaskNode) FetchProfile(peerID string, useCache bool) (pb.Profile, error) {
	var pro pb.Profile
...
func (n *developertaskNode) UpdateProfile(profile *pb.Profile) error {
...
func (n *developertaskNode) PatchProfile(patch map[string]interface{}) error {
	profilePath := path.Join(n.RepoPath, "root", "profile.json")
...
func (n *developertaskNode) appendCountsToProfile(profile *pb.Profile) (*pb.Profile, bool) {
...
func (n *developertaskNode) updateProfileCounts() error {
	profilePath := path.Join(n.RepoPath, "root", "profile.json")
...
func (n *developertaskNode) updateProfileRatings(newRating *pb.Rating) error {
	profilePath := path.Join(n.RepoPath, "root", "profile.json")
	profile := new(pb.Profile)
	_, ferr := os.Stat(profilePath)
	if !os.IsNotExist(ferr) {
