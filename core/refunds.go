...
func (n *developertaskNode) RefundOrder(contract *pb.RicardianContract, records []*wallet.TransactionRecord) error {
...
func (n *developertaskNode) SignRefund(contract *pb.RicardianContract) (*pb.RicardianContract, error) {
...
func (n *developertaskNode) VerifySignaturesOnRefund(contract *pb.RicardianContract) error {
