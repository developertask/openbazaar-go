...
func (n *developertaskNode) Spend(args *SpendRequest) (*SpendResponse, error) {
	var (
...
func (n *developertaskNode) getOrderContractBySpendRequest(args *SpendRequest) (*pb.RicardianContract, error) {
