...
func (n *developertaskNode) BuildTransactionRecords(contract *pb.RicardianContract, records []*wallet.TransactionRecord, state pb.OrderState) ([]*pb.TransactionRecord, *pb.TransactionRecord, error) {
...
func (n *developertaskNode) LookupCurrency(currencyCode string) (repo.CurrencyDefinition, error) {
	return repo.AllCurrencies().Lookup(currencyCode)
}

func (n *developertaskNode) ValidateMultiwalletHasPreferredCurrencies(data repo.SettingsData) error {
