...
```
cookie: developertask_Auth_Cookie=2Yc7VZtG/pVKrH5Lp0mKRSEPC4xlm1dGpkbUXLehTUI
```
...
The instructions to set up SSL can be found in a separate [doc](https://github.com/developertask/openbazaar-go/blob/master/docs/ssl.md). 
