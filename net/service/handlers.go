...
import (
	...
	"github.com/developertask/openbazaar-go/net"
	"github.com/developertask/openbazaar-go/pb"
	"github.com/developertask/openbazaar-go/repo"
	ut "github.com/developertask/openbazaar-go/util"
...
func (service *developertaskService) HandlerForMsgType(t pb.Message_MessageType) func(peer.ID, *pb.Message, interface{}) (*pb.Message, error) {
	switch t {
...
func (service *developertaskService) handlePing(peer peer.ID, pmes *pb.Message, options interface{}) (*pb.Message, error) {
	log.Debugf("Received PING message from %s", peer.Pretty())
	return pmes, nil
}

func (service *developertaskService) handleFollow(pid peer.ID, pmes *pb.Message, options interface{}) (*pb.Message, error) {
	if pmes.Payload == nil {
...
func (service *developertaskService) handleUnFollow(pid peer.ID, pmes *pb.Message, options interface{}) (*pb.Message, error) {
	if pmes.Payload == nil {
		return nil, ErrEmptyPayload
	}
	sd := new(pb.SignedData)
...
func (service *developertaskService) handleOfflineAck(p peer.ID, pmes *pb.Message, options interface{}) (*pb.Message, error) {
	if pmes.Payload == nil {
...
func (service *developertaskService) handleOfflineRelay(p peer.ID, pmes *pb.Message, options interface{}) (*pb.Message, error) {
...
func (service *developertaskService) handleOrder(peer peer.ID, pmes *pb.Message, options interface{}) (*pb.Message, error) {
...
func (service *developertaskService) handleOrderConfirmation(p peer.ID, pmes *pb.Message, options interface{}) (*pb.Message, error) {
...
func (service *developertaskService) handleOrderCancel(p peer.ID, pmes *pb.Message, options interface{}) (*pb.Message, error) {
	if pmes.Payload == nil {
		return nil, ErrEmptyPayload
	}
...
func (service *developertaskService) handleReject(p peer.ID, pmes *pb.Message, options interface{}) (*pb.Message, error) {
	if pmes.Payload == nil {
		return nil, ErrEmptyPayload
	}
...
func (service *developertaskService) handleRefund(p peer.ID, pmes *pb.Message, options interface{}) (*pb.Message, error) {
	if pmes.Payload == nil {
		return nil, ErrEmptyPayload
	}
...
func (service *developertaskService) handleOrderFulfillment(p peer.ID, pmes *pb.Message, options interface{}) (*pb.Message, error) {
...
func (service *developertaskService) handleOrderCompletion(p peer.ID, pmes *pb.Message, options interface{}) (*pb.Message, error) {
...
func (service *developertaskService) handleDisputeOpen(p peer.ID, pmes *pb.Message, options interface{}) (*pb.Message, error) {
...
func (service *developertaskService) handleDisputeUpdate(p peer.ID, pmes *pb.Message, options interface{}) (*pb.Message, error) {
...
func (service *developertaskService) handleDisputeClose(p peer.ID, pmes *pb.Message, options interface{}) (*pb.Message, error) {
...
func (service *developertaskService) handleOrderProcessingFailure(p peer.ID, pmes *pb.Message, options interface{}) (*pb.Message, error) {
	if pmes.Payload == nil {
		return nil, ErrEmptyPayload
	}
...
func (service *developertaskService) handleChat(p peer.ID, pmes *pb.Message, options interface{}) (*pb.Message, error) {
...
func (service *developertaskService) handleModeratorAdd(pid peer.ID, pmes *pb.Message, options interface{}) (*pb.Message, error) {
	if pmes.Payload == nil {
		return nil, ErrEmptyPayload
	}
	sd := new(pb.SignedData)
...
func (service *developertaskService) handleModeratorRemove(pid peer.ID, pmes *pb.Message, options interface{}) (*pb.Message, error) {
	if pmes.Payload == nil {
		return nil, ErrEmptyPayload
	}
	sd := new(pb.SignedData)
...
func (service *developertaskService) handleBlock(pid peer.ID, pmes *pb.Message, options interface{}) (*pb.Message, error) {
...
func (service *developertaskService) handleVendorFinalizedPayment(pid peer.ID, pmes *pb.Message, options interface{}) (*pb.Message, error) {
	if pmes.Payload == nil {
		return nil, ErrEmptyPayload
	}
...
func (service *developertaskService) handleStore(pid peer.ID, pmes *pb.Message, options interface{}) (*pb.Message, error) {
	// If we aren't accepting store requests then ban this peer
	if !service.node.AcceptStoreRequests {
		service.node.BanManager.AddBlockedId(pid)
		return nil, nil
...
func (service *developertaskService) handleOrderPayment(peer peer.ID, pmes *pb.Message, options interface{}) (*pb.Message, error) {
...
func (service *developertaskService) handleError(peer peer.ID, pmes *pb.Message, options interface{}) (*pb.Message, error) {
	if pmes.Payload == nil {
...
func (service *developertaskService) SendProcessingError(peerID, orderID string, attemptedMessage pb.Message_MessageType, latestContract *pb.RicardianContract) error {
