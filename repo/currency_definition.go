...
var (
	...
	mainnetCryptoDefinitions = map[string]CurrencyDefinition{
		...
		"GLEEC": {Name: "Gleecbtc", Code: CurrencyCode("GLEEC"), CurrencyType: Crypto, Divisibility: 8, BlockTime: 150 * time.Second},
	...
	testnetCryptoDefinitions = map[string]CurrencyDefinition{
		...
		"TGLEEC": {Name: "Testnet Gleecbtc", Code: CurrencyCode("TGLEEC"), CurrencyType: Crypto, Divisibility: 8, BlockTime: 150 * time.Second},
