...
type Migration016WalletsConfig struct {
	...
	GLEEC *migration016CoinConfig `json:"GLEEC"`
...
func migration016PreviousWalletConfig() *Migration016WalletsConfig {
	...
	c.GLEEC.APIPool = []string{"https://ltc.api.openbazaar.org/api"}
	c.GLEEC.APITestnetPool = []string{"https://tltc.api.openbazaar.org/api"}
