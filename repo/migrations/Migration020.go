...
import (
	...
	dhtpb "github.com/developertask/openbazaar-go/repo/migrations/helpers/Migration020"
...
func (Migration020) Up(repoPath string, dbPassword string, testnet bool) error {
	...
	// Open our developertask db and grab the identity key
...
func (Migration020) Down(repoPath string, dbPassword string, testnet bool) error {
	...
	// Migrate the developertask and IPFS repo versions
