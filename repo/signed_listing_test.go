...
import (
	...
	"github.com/developertask/openbazaar-go/test"
...
func TestSignedListingAttributes(t *testing.T) {
	var examples = []struct {
		...
		},
		{
			...
			expectedAcceptedCurrencies: []string{"ZEC", "GLEEC", "BTC", "BCH"},
			expectedCryptoDivisibility: 0,
			expectedCryptoCurrencyCode: "",
		},
		{
		...
		},
		{
			...
			expectedAcceptedCurrencies: []string{"ZEC", "GLEEC", "BCH", "BTC"},
			expectedCryptoDivisibility: 0,
			expectedCryptoCurrencyCode: "",
		},
		{
		...
		},
		{
			...
			expectedAcceptedCurrencies: []string{"BTC", "BCH", "ZEC", "GLEEC", "ETH"},
			expectedCryptoDivisibility: 0,
			expectedCryptoCurrencyCode: "",
		},
	}
