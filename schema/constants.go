...
const (
	CoinAPIdevelopertaskBTC = "https://btc.api.openbazaar.org/api"
	CoinAPIdevelopertaskBCH = "https://bch.api.openbazaar.org/api"
	CoinAPIdevelopertaskGLEEC = "https://ltc.api.openbazaar.org/api"
	CoinAPIdevelopertaskZEC = "https://zec.api.openbazaar.org/api"
	CoinAPIdevelopertaskETH = "https://mainnet.infura.io"

	CoinAPIdevelopertaskTBTC = "https://tbtc.api.openbazaar.org/api"
	CoinAPIdevelopertaskTBCH = "https://tbch.api.openbazaar.org/api"
	CoinAPIdevelopertaskTGLEEC = "https://tltc.api.openbazaar.org/api"
	CoinAPIdevelopertaskTZEC = "https://tzec.api.openbazaar.org/api"
	CoinAPIdevelopertaskTETH = "https://rinkeby.infura.io"
)

var (
	CoinPoolBTC = []string{CoinAPIdevelopertaskBTC}
	CoinPoolBCH = []string{CoinAPIdevelopertaskBCH}
	CoinPoolGLEEC = []string{CoinAPIdevelopertaskGLEEC}
	CoinPoolZEC = []string{CoinAPIdevelopertaskZEC}
	CoinPoolETH = []string{CoinAPIdevelopertaskETH}

	CoinPoolTBTC = []string{CoinAPIdevelopertaskTBTC}
	CoinPoolTBCH = []string{CoinAPIdevelopertaskTBCH}
	CoinPoolTGLEEC = []string{CoinAPIdevelopertaskTGLEEC}
	CoinPoolTZEC = []string{CoinAPIdevelopertaskTZEC}
	CoinPoolTETH = []string{CoinAPIdevelopertaskTETH}
)
