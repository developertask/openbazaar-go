...
// NewNode creates a new *core.developertaskNode prepared for testing
func NewNode() (*core.developertaskNode, error) {
	// Create test repo
	...
	// Put it all together in an developertaskNode
