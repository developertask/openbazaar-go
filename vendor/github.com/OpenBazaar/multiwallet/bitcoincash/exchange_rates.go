...
func NewBitcoinCashPriceFetcher(dialer proxy.Dialer) *BitcoinCashPriceFetcher {
	...
	b.providers = []*ExchangeRateProvider{
		{"https://ticker.openbazaar.org/api", b.cache, client, developertaskDecoder{}},
	}
	return &b
}
...
func (b developertaskDecoder) decode(dat interface{}, cache map[string]float64) (err error) {
