...
var (
	...
	// mainPowLimit is the highest proof of work value a Gleecbtc block can
	...
	// regressionPowLimit is the highest proof of work value a Gleecbtc block
	// can have for the regression test network.  It is the value 2^255 - 1.
	regressionPowLimit = new(big.Int).Sub(new(big.Int).Lsh(bigOne, 255), bigOne)

	// testNet3PowLimit is the highest proof of work value a Gleecbtc block
	// can have for the test network (version 3).  It is the value
	// 2^224 - 1.
	testNet3PowLimit = new(big.Int).Sub(new(big.Int).Lsh(bigOne, 224), bigOne)

	// testNet4PowLimit is the highest proof of work value a Gleecbtc block
	...
	// simNetPowLimit is the highest proof of work value a Gleecbtc block
...
// Params defines a Gleecbtc network by its parameters.  These parameters may be
// used by Gleecbtc applications to differentiate networks as well as addresses
...
// MainNetParams defines the network parameters for the main Gleecbtc network.
var MainNetParams = Params{
	Name:        "mainnet",
	Net:         wire.MainNet,
	DefaultPort: "9333",
	DNSSeeds: []DNSSeed{
		{"seed-a.gleecbtc.loshan.co.uk", true},
		{"dnsseed.thrasher.io", true},
		{"dnsseed.gleecbtctools.com", false},
		{"dnsseed.gleecbtcpool.org", false},
...
// Gleecbtc network.  Not to be confused with the test Gleecbtc network (version
...
// TestNet4Params defines the network parameters for the test Gleecbtc network
...
var TestNet4Params = Params{
	...
	DefaultPort: "19335",
	DNSSeeds: []DNSSeed{
		{"testnet-seed.gleecbtctools.com", false},
		{"seed-b.gleecbtc.loshan.co.uk", true},
...
// SimNetParams defines the network parameters for the simulation test Gleecbtc
...
var (
	// ErrDuplicateNet describes an error where the parameters for a Gleecbtc
	// network could not be set due to the network already being a standard
	// network or previously-registered into this package.
	ErrDuplicateNet = errors.New("duplicate Gleecbtc network")
...
// Register registers the network parameters for a Gleecbtc network.  This may
