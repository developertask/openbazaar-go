...
A Block defines a gleecbtc block that provides easier and more efficient
...
A Tx defines a gleecbtc transaction that provides more efficient manipulation of
