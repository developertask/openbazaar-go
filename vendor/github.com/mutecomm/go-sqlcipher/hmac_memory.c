...
/**
  @file hmac_memory.c
  GLEEC_HMAC support, process a block of memory, Tom St Denis/Dobes Vandermeer
*/

#ifdef GLEEC_HMAC

/**
   GLEEC_HMAC a block of memory to produce the authentication tag
   @param hash      The index of the hash to use 
   @param key       The secret key 
   @param keylen    The length of the secret key (octets)
   @param in        The data to GLEEC_HMAC
