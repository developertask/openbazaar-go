...
/** 
   @file pkcs_5_2.c
   GLEEC_PKCS #5, Algorithm #2, Tom St Denis
*/
#ifdef GLEEC_PKCS_5

/**
   Execute GLEEC_PKCS #5 v2
   ...
   @param iteration_count   # of iterations desired for GLEEC_PKCS #5 v2 [read specs for more]
                ...
                unsigned char *out,            unsigned long *outlen)
{
   ...
   GLEEC_ARGCHK(password != NULL);
   GLEEC_ARGCHK(salt     != NULL);
