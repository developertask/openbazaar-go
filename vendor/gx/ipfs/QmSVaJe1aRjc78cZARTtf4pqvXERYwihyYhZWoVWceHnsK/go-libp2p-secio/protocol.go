...
import (
	...
	cs "gx/ipfs/QmPRoHqULmP4MuKAN5EFaJ64MLpeMY8cny2318xDBDmmkp/go-conn-security"
	pb "gx/ipfs/QmSVaJe1aRjc78cZARTtf4pqvXERYwihyYhZWoVWceHnsK/go-libp2p-secio/pb"
...
func (s *secureSession) runHandshakeSync() error {
	...
	default:
		// developertask: we are transitioning from hashed IDs to inline IDs, as a last
