...
import (
	...
	autobatch "gx/ipfs/QmUadX5EcvrBmxAV9sE7wUWtWSqxns5K84qKJBixmcT1w9/go-datastore/autobatch"
		...
		case <-tick.C:
			...
			for {
				...
				for p, t := range provs.set {
					// developertask: the provider is usually deleted after it reaches ProvideValidity. However, since
