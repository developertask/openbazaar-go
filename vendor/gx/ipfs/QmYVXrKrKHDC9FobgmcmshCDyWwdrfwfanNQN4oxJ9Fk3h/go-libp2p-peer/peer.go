...
// developertask: test both inline and and hashes pubkeys.
...
func IDFromPublicKey(pk ic.PubKey) (ID, error) {
	...
	// developertask: handle the Sum error
...
// the pubkey bytes.
// developertask: temporary helper to isolate the
...
// of the pubkey bytes.
// developertask: temporary helper function to
...
// developertask: This allows legacy IDs
